...
LESSER_THAN_OPEN = str.encode('<lesser_than>')
LESSER_THAN_CLOSED = str.encode('<lesser_than/>')
GREATER_THAN_OPEN = str.encode('<greater_than>')
GREATER_THAN_CLOSED = str.encode('<greater_than/>')
BLACK_DOT_OPEN = str.encode('<black_dot>')
BLACK_DOT_CLOSED = str.encode('<black_dot/>')
LEFT_ARROW_OPEN = str.encode('<left_arrow>')
LEFT_ARROW_CLOSED = str.encode('<left_arrow/>')
